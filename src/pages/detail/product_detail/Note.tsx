...
interface NoteProps {
    productType?: string; // productType 속성 추가
}
...
const NoteSection: React.FC<NoteSectionProps> = ({ title, items }) => {
    return (
...
const Note: React.FC<NoteProps> = ({ productType }) => {
    // productType 매개변수 추가
